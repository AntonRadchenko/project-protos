...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\rR\x02id2\x94\x02\n" +
	"\vUserService\x121\n" +
	"\n" +
	...
	".user.User\x123\n" +
	"\tListUsers\x12\x16.google.protobuf.Empty\x1a\x0e.user.UserList\x121\n" +
	"\n" +
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	3, // 8: user.UserService.ListUsers:output_type -> user.UserList
